...
mixin _$Story {
 ...
 String get name; String get description; String get photoUrl; String get id; String get createdAt; double? get lat; double? get lon;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,name,description,photoUrl,id,createdAt,lat,lon);

@override
String toString() {
  return 'Story(name: $name, description: $description, photoUrl: $photoUrl, id: $id, createdAt: $createdAt, lat: $lat, lon: $lon)';
}
...
@useResult
$Res call({
 String name, String description, String photoUrl, String id, String createdAt, double? lat, double? lon
});
...
/// Create a copy of Story
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = null,Object? description = null,Object? photoUrl = null,Object? id = null,Object? createdAt = null,Object? lat = freezed,Object? lon = freezed,}) {
...
class _Story implements Story {
  const _Story({required this.name, required this.description, required this.photoUrl, required this.id, required this.createdAt, this.lat, this.lon});
...
/// Create a copy of Story
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = null,Object? description = null,Object? photoUrl = null,Object? id = null,Object? createdAt = null,Object? lat = freezed,Object? lon = freezed,}) {
  return _then(_Story(
name: null == name ? _self.name : name // ignore: cast_nullable_to_non_nullable
as String,description: null == description ? _self.description : description // ignore: cast_nullable_to_non_nullable
as String,photoUrl: null == photoUrl ? _self.photoUrl : photoUrl // ignore: cast_nullable_to_non_nullable
